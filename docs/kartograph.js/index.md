...
*This documentation is work in progress. If you want to help improving this, you're invited to [fork it on Github](https://github.com/kartograph/kartograph.org/blob/master/docs/kartograph.js/index.md)*
